...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonClassMonitorStorage classMonitorStorage =
                new JsonClassMonitorStorage(temporaryFolder.resolve("classMonitor.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(classMonitorStorage, userPrefsStorage);
    ...
    private void assertCommandFailure(String inputCommand, Class<? extends Throwable> expectedException,
        ...
        Model expectedModel = new ModelManager(model.getClassMonitor(), new UserPrefs());
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an ClassMonitorStorage that throws the IOException e when saving
        JsonClassMonitorStorage classMonitorStorage = new JsonClassMonitorStorage(prefPath) {
            @Override
            public void saveClassMonitor(ReadOnlyClassMonitor classMonitor, Path filePath)
                    throws IOException {
                throw e;
            }
        };
        ...
        // Triggers the saveClassMonitor method by executing an add command
